export default function Page1(props){
    return(
        ...
        <p className="pl-10 text-[#8E8E8E]">Please provide all current information accurately.</p>
              ...
              <input type="email" placeholder="Email" className="rounded-[8px] h-[3rem] w-[26rem] border-[1px] border-[#cbd5e1] pl-4 ml-10 mt-2  "></input>
              <p className="pl-10 mt-2 font-bold ">Phone number *</p>
              <input type="number" placeholder="Phone number" className="rounded-[8px] h-[3rem] w-[26rem] border-[1px] border-[#cbd5e1] pl-4 ml-10 mt-2"></input>
              ...
              <div className="flex ">
              <button onClick={props.back} className="w-[8rem] h-[3rem] border-2 border-solid rounded-[6px] font-bold text-[1rem] mt-[4rem] ml-10"> Back</button>
              <button onClick={props.next}  className="w-[24rem] h-[3rem] bg-[#d6d8db] rounded-[6px] text-[#A9ACAF] text-[1rem] mt-[4rem] ml-2 mr-14"> Continue 2/3</button>
              </div>
                </form>
